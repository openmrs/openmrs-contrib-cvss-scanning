...
@pytest_bdd.scenario('authentication.feature', 'Correct credentials allows login on login page')
def test_correct_credentials_allows_login_on_login_page(username, password):
    pass