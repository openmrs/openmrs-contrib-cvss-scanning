...
def test_lockout_on_rest_api_is_accessible_after_4_minutes_and_50_seconds(cleanup_clear_user_lockout, username, password):
 pass
    
@pytest_bdd.then('the user should not be authenticated')
def then_the_correct_credentials_should_not_log_into_the_rest_api(login_data):
